...
- caption_instagram: Un caption atractivo para Instagram, estructurado de forma donde se desglosen las características del producto y se inviten a comprar (máximo 150 caracteres, con emojis relevantes)
